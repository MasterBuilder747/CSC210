...
public class EmployeeRecord {
    ...
    public EmployeeRecord(String name, int id, float salary) { //overloading: use different sets of parameters for the same constructor
    ...
    public static int getNumEmploy() {
